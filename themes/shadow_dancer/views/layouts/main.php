...
<div class="container" id="page">
	...
	<?php 
		...
		?>
			<div class="topnav_text"><a href='<?=Yii::app()->createUrl("site/login");?>'>login</a> </div>
		
		<?php
		}
		else{
		?>
			<div class="topnav_text"><a href='<?=Yii::app()->createUrl("site/logout");?>'>Logout</a> </div>
		<?php
		}	
	?>
	...
	<div id="mainmenu">
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Member', 'url'=>array('member/index'),'itemOptions'=>array('class'=>'icon_chart')),
			),
		)); ?>
	</div> <!--mainmenu -->
